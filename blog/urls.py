...
urlpatterns=[
    ...
    url(r'^writer/(folder/(?P<fmid>\w*)/?(article/(?P<amid>\w*))?)?$', views.writer, name='writer'),
    ...
    url(r'^get_articles_of_folder/$', views.get_articles_of_folder, name='get_articles_of_folder'),
]
